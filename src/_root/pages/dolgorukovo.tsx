...
const Dolgorukovo: React.FC = () => {
    const monuments = attractions.filter(attraction => attraction.category === "dolgorukovo");
  ...
  return (
    <div>
      <img src="/assets/Dolgorukovo.png" alt="" />
      <ul>
