...
const Dobrinka: React.FC = () => {
  const monuments = attractions.filter(attraction => attraction.category === "dobrinka");
  ...
  return (
    <div>
      <img src="/assets/dobrinka.png" alt="" />
      <ul>
