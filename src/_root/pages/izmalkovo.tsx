...
const Izmalkovo: React.FC = () => {
  const monuments = attractions.filter(attraction => attraction.category === "izmalkovo");
  ...
  return (
    <div>
      <img src="/assets/izmalkovoo.png" alt="" />
      <ul>
